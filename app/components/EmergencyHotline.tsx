...
export default function EmergencyHotline() {
  ...
  return (
    <section className="relative py-24 bg-dark overflow-hidden">
      ...
      >
        {/* Emergency label with pulsing dot */}
        <motion.div
        ...
        <motion.h2
          ...
          className="font-baskerville text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-12"
        >
          Emergency Hotline
        </motion.h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          {[
            ...
            <motion.a
              ...
              className="group flex flex-col items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-[#3CAA35]/50 transition-all duration-300"
              target="_blank"
